...
export default async function ProposalDetailPage({ params }: Props) {
  ...
  const { data: proposal, error } = await supabase
    ...
    .select(`
      ...
      created_at,
      clients(name, slug, contact_email),
  ...
  const client = proposal.clients as unknown as { name: string; slug: string; contact_email: string | null };
        ...
        breadcrumbs={
          <Breadcrumb
            items={[
              ...
              { label: client.name, href: `/admin/clients/${slug}` },
              { label: 'Proposal' },
            ]}
          />
        }
